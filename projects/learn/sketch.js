...
let sclX = 30; // Size of the Tiles.
let sclY = 30; // Size of the Tiles.
let bdr = 0; // Keep border value more than scale in order to work
let mrg = 0;
...
function setupPattern() {
  ...
  grid[1][0].nextState = 1;
  grid[2][1].nextState = 1;
  grid[0][2].nextState = 1;
  grid[1][2].nextState = 1;
  grid[2][2].nextState = 1;
}
